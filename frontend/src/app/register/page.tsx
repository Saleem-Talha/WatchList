...
export default function RegisterPage() {
  ...
  return (
    <PublicLayout>
      {/* Page background ornaments to match landing page */}
      ...
      <div className="mx-auto max-w-md px-6 py-12">
        <LayoutCard
          ...
          subtitle="Start building your personal watchlist and get email reminders when it’s time to watch."
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative py-1">
              ...
              <div className="relative flex justify-center">
                <span className="bg-white px-2 text-xs text-slate-500">Already have an account?</span>
              </div>
            </div>
